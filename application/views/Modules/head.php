...
<head>
	...
	<title><?= $title; ?></title>
	<link rel="icon" type="image/svg+xml" href="<?= base_url('Public'); ?>/images/logo/logo.svg" sizes="any">
	...
	<link href="<?= base_url('Public'); ?>/assets/lib/font-awesome/4.3/css/font-awesome.min.css" rel="stylesheet"
		type="text/css" />
	...
	<link href="<?= base_url('Public'); ?>/assets/lib/Datetables.js/datatables.min.css" rel="stylesheet"
		type="text/css" />
	<link href="<?= base_url('Public'); ?>/assets/lib/bootstrap-datetimepicker/dist/css/bootstrap-datetimepicker.min.css"
		rel="stylesheet" />
	<link href="<?= base_url('Public'); ?>/assets/stylesheets/own.css" rel="stylesheet" type="text/css" />
	<link href="<?= base_url('Public'); ?>/assets/lib/formToWizard/css/jquery.steps.css" rel="stylesheet"
		type="text/css" />
	...
	<script src="<?= base_url('Public'); ?>/assets/lib/bootstrap-datetimepicker/dist/js/bootstrap-datetimepicker.min.js">
	</script>
