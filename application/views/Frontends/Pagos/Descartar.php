                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= money_format_cop($ListaDatos3[$item["CodPedido"]]["saldo"]); ?>" class="form-control" disabled style="background-color: #ffffff;" id="SaldoActual" name="SaldoActual">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Valor Pedido</label>
                                    <input type="text" value="<?= money_format_cop($item["Valor1"]); ?>" class="form-control" disabled style="background-color: #ffffff;">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= money_format_cop($item["ValCuota"]); ?>" class="form-control" disabled style="background-color: #ffffff;" id="SaldoActual" name="SaldoActual">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= money_format_cop($ListaDatos3[$item["CodPedido"]]["UltimoPago"]); ?>" class="form-control" disabled style="background-color: #ffffff;">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                ...
                                <form id="form-descartarPago">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= money_format_cop($dataPago[0]["Cuota"]); ?>" class="form-control" max="<?= $ListaDatos3[$item["CodPedido"]]["saldo"]; ?>" id="NuevoAbono" name="NuevoAbono" disabled style="background-color: #ffffff;">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
