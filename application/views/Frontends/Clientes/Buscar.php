...
<div class="content">
    ...
    <div class="main-content">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 col-md-offset-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre" id="nombre" class="form-control" <?php if (!$btn) { ?>
                                                readonly="true" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cedula" id="cedula" class="form-control" <?php if (!$btn) { ?>
                                                readonly="true" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="evento">Evento/Domingo:</label>
                                            <input type="text" name="evento" id="evento" class="form-control" <?php if (!$btn) { ?>
                                                readonly="true" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="direccion" id="direccion" class="form-control" <?php if (!$btn) { ?>
                                                readonly="true" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-md-offset-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telefono" id="telefono" class="form-control" <?php if (!$btn) { ?>
                                                readonly="true" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="ubicacion">Factura:</label>
                                            <input type="text" name="ubicacion" id="ubicacion" class="form-control" <?php if (!$btn) { ?>
                                                readonly="true" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="selectEstados" id="selectEstados" class="form-control" <?php if (!$btn) { ?>
                                                disabled <?php } ?>>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group text-center">
                                            <br />
                                            <button id="btn-buscar" name="btn-buscar"
                                                class="btn btn-primary <?php if (!$btn) { ?> disabled <?php } ?>"><i class="fa fa-search"></i>
                                                Buscar Clientes</button>
                                            <button id="btn-limpiar-filtro" name="btn-limpiar-filtro"
                                                class="btn btn-default <?php if (!$btn) { ?> disabled <?php } ?>"><i class="fa fa-eraser"></i>
                                                Limpiar</button>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="ModalDevol" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true">
                ...
                <div class="modal-content">
                    <form method="POST" name="form-modal" id="form-modal">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="modal-cuotas" name="modal-cuotas" class="form-control" readonly
                                            style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="modal-saldo" name="modal-saldo" class="form-control" readonly
                                            style="background-color:#ffffff;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="modal-val" name="modal-val" class="form-control" <?php if (!$btnD) { ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Tipo:</label>
                                        <select name="modal-tipo" id="modal-tipo" class="form-control required" <?php if (!$btnD) { ?>
                                            disabled <?php } ?> style="background-color:#ffffff;">
                                            <option value=""></option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="modal-cobrador" id="modal-cobrador" class="form-control required"
                                            <?php if (!$btnD) { ?> disabled <?php } ?> style="background-color:#ffffff;">
                                            <option value=""></option>
                                            <?php
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="6" class="form-control" name="modal-obs" id="modal-obs" <?php if (!$btnD) { ?>
                                            disabled <?php } ?> style="resize: none; background-color:#ffffff;"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row <?php if (!$btnD) { ?> hidden <?php } ?>">
                                <div class="col-md-12">
                                    <p class="error-text" style="color:red;"><i class="fa fa-warning modal-icon"></i>¿Desea hacer la
                                        devolución de este Cliente? <br><i>*Recuerde que no se podrá revertir esta acción*</i></p>
                                </div>
                            </div>
                            <br>
                            <div class="col-md-12">
                        ...
                        <div class="modal-footer" style="margin-top: -15px;">
                            <button id="btn-modal-cerrar" name="btn-modal-cerrar"
                                class="btn btn-default <?php if (!$btnD) { ?> hidden <?php } ?>" data-dismiss="modal"
                                aria-hidden="true">Cerrar</button>
                            <button id="btn-modal" name="btn-modal"
                                class="btn btn-primary <?php if (!$btnD) { ?> hidden <?php } ?>"><i class="fa fa-reply-all"></i>
                                Devolver</button>
                        </div>
                    </form>
                </div>
        ...
        <script>
            ...
            function buscar() {
                ...
                listarFiltro(nombre, cedula, direccion, evento, telefono, selectEstados, ubicacion);
            ...
            function listarFiltro(nombre, cedula, direccion, evento, telefono, selectEstados, ubicacion) {
                $('#<?= $Controller; ?>').DataTable({
                    bDestroy: true,
                    responsive: true,
                    scrollX: true,
