                                ...
                                <div>                                
                                    ...
                                    <section style="margin-top:-15px;" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" placeholder="Documento" minlength="7" maxlength="15"  value="" class="form-control required number" id="Documento" name="Documento">
                                        </div>                                    
                                    </section>
                                    ...
                                    <section style="margin-top:-15px;" >
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Manzana / Conjunto</label>
                                                    <input type="text" placeholder="Manzana / Conjunto" value="" class="form-control" id="Manzana" maxlength="10" name="Manzana">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
